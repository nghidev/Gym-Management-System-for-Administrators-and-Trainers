                ...
                @if (Auth::user()->role === 1)
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse"
                            href="#">
                            <i class="bi bi-layout-text-window-reverse"></i><span>Dinh dưỡng</span><i
                                class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <a href="{{ route('food.index') }}">
                                    <i class="bi bi-circle"></i><span>Quản lý thực đơn</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('nutrient.index') }}">
                                    <i class="bi bi-circle"></i><span>quản lý dinh dưỡng</span>
                                </a>
                            </li>
                        </ul>
                    </li><!-- End Tables Nav -->
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse"
                            href="#">
                            <i class="bi bi-bar-chart"></i><span>Tập luyện</span><i
                                class="bi bi-chevron-down ms-auto"></i>
                        </a>
                        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <a href="{{ route('muscle_groups.index') }}">
                                    <i class="bi bi-circle"></i><span>Quản lý nhóm cơ</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('muscle.index') }}">
                                    <i class="bi bi-circle"></i><span>Quản lý cơ</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('exercise.index') }}">
                                    <i class="bi bi-circle"></i><span>Quản lý bài tập</span>
                                </a>
                            </li>
                ...
                @else
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="{{ route('coach.listusers') }}">
                          <i class="bi bi-person"></i>
                          <span>Tập Luyện & Dinh Dưỡng</span>
                        </a>
                      </li>
                        {{-- <li class="nav-item">
                            <a class="nav-link collapsed" href="{{ route('coach.listusers') }}">
